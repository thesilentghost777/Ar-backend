...
@section('page-title', 'Créer une nouvelle leçon')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-primary-500 to-primary-600 px-6 py-4">
            <h2 class="text-xl font-semibold text-white">
                <i class="fas fa-graduation-cap mr-2"></i> Nouvelle leçon
            </h2>
        </div>

        <form action="{{ route('admin.auto-ecole.lecons.store') }}" method="POST" class="p-6 space-y-6">
            @csrf

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Chapitre *</label>
                    <select name="chapitre_id" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 @error('chapitre_id') border-red-500 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="titre" value="{{ old('titre') }}" required
                        placeholder="Ex: Les feux tricolores"
                ...
                <div>
                    ...
                    <input type="number" name="duree_minutes" value="{{ old('duree_minutes', 10) }}" required min="1"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="contenu_texte" rows="8"
                    ...
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500">{{ old('contenu_texte') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="url" name="url_web" value="{{ old('url_web') }}"
                        placeholder="https://..."
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500">
                </div>
            </div>
